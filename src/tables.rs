...
pub mod general_category {
    ...
    const GENERAL_CATEGORY: &[(char, char, GeneralCategory)] = &[
        ...
        ('\u{531}', '\u{556}', GeneralCategory::UppercaseLetter), ('\u{558}', '\u{559}',
        ...
        GeneralCategory::DashPunctuation), ('\u{58b}', '\u{58c}', GeneralCategory::ModifierLetter),
        ('\u{58d}', '\u{58e}', GeneralCategory::OtherSymbol), ('\u{58f}', '\u{58f}',
        GeneralCategory::CurrencySymbol), ('\u{591}', '\u{5bd}', GeneralCategory::NonspacingMark),
        ('\u{5be}', '\u{5be}', GeneralCategory::DashPunctuation), ('\u{5bf}', '\u{5bf}',
        GeneralCategory::NonspacingMark), ('\u{5c0}', '\u{5c0}', GeneralCategory::OtherPunctuation),
        ('\u{5c1}', '\u{5c2}', GeneralCategory::NonspacingMark), ('\u{5c3}', '\u{5c3}',
        GeneralCategory::OtherPunctuation), ('\u{5c4}', '\u{5c5}', GeneralCategory::NonspacingMark),
        ('\u{5c6}', '\u{5c6}', GeneralCategory::OtherPunctuation), ('\u{5c7}', '\u{5c9}',
        GeneralCategory::NonspacingMark), ('\u{5d0}', '\u{5ea}', GeneralCategory::OtherLetter),
        ('\u{5ef}', '\u{5f2}', GeneralCategory::OtherLetter), ('\u{5f3}', '\u{5f4}',
        GeneralCategory::OtherPunctuation), ('\u{600}', '\u{605}', GeneralCategory::Format),
        ('\u{606}', '\u{608}', GeneralCategory::MathSymbol), ('\u{609}', '\u{60a}',
        GeneralCategory::OtherPunctuation), ('\u{60b}', '\u{60b}', GeneralCategory::CurrencySymbol),
        ('\u{60c}', '\u{60d}', GeneralCategory::OtherPunctuation), ('\u{60e}', '\u{60f}',
        GeneralCategory::OtherSymbol), ('\u{610}', '\u{61a}', GeneralCategory::NonspacingMark),
        ('\u{61b}', '\u{61b}', GeneralCategory::OtherPunctuation), ('\u{61c}', '\u{61c}',
        GeneralCategory::Format), ('\u{61d}', '\u{61f}', GeneralCategory::OtherPunctuation),
        ('\u{620}', '\u{63f}', GeneralCategory::OtherLetter), ('\u{640}', '\u{640}',
        GeneralCategory::ModifierLetter), ('\u{641}', '\u{64a}', GeneralCategory::OtherLetter),
        ('\u{64b}', '\u{65f}', GeneralCategory::NonspacingMark), ('\u{660}', '\u{669}',
        GeneralCategory::DecimalNumber), ('\u{66a}', '\u{66d}', GeneralCategory::OtherPunctuation),
        ('\u{66e}', '\u{66f}', GeneralCategory::OtherLetter), ('\u{670}', '\u{670}',
        GeneralCategory::NonspacingMark), ('\u{671}', '\u{6d3}', GeneralCategory::OtherLetter),
        ('\u{6d4}', '\u{6d4}', GeneralCategory::OtherPunctuation), ('\u{6d5}', '\u{6d5}',
        GeneralCategory::OtherLetter), ('\u{6d6}', '\u{6dc}', GeneralCategory::NonspacingMark),
        ('\u{6dd}', '\u{6dd}', GeneralCategory::Format), ('\u{6de}', '\u{6de}',
        GeneralCategory::OtherSymbol), ('\u{6df}', '\u{6e4}', GeneralCategory::NonspacingMark),
        ('\u{6e5}', '\u{6e6}', GeneralCategory::ModifierLetter), ('\u{6e7}', '\u{6e8}',
        GeneralCategory::NonspacingMark), ('\u{6e9}', '\u{6e9}', GeneralCategory::OtherSymbol),
        ('\u{6ea}', '\u{6ed}', GeneralCategory::NonspacingMark), ('\u{6ee}', '\u{6ef}',
        GeneralCategory::OtherLetter), ('\u{6f0}', '\u{6f9}', GeneralCategory::DecimalNumber),
        ('\u{6fa}', '\u{6fc}', GeneralCategory::OtherLetter), ('\u{6fd}', '\u{6fe}',
        GeneralCategory::OtherSymbol), ('\u{6ff}', '\u{6ff}', GeneralCategory::OtherLetter),
        ('\u{700}', '\u{70d}', GeneralCategory::OtherPunctuation), ('\u{70f}', '\u{70f}',
        GeneralCategory::Format), ('\u{710}', '\u{710}', GeneralCategory::OtherLetter), ('\u{711}',
        '\u{711}', GeneralCategory::NonspacingMark), ('\u{712}', '\u{72f}',
        GeneralCategory::OtherLetter), ('\u{730}', '\u{74a}', GeneralCategory::NonspacingMark),
        ('\u{74d}', '\u{7a5}', GeneralCategory::OtherLetter), ('\u{7a6}', '\u{7b0}',
        GeneralCategory::NonspacingMark), ('\u{7b1}', '\u{7b1}', GeneralCategory::OtherLetter),
        ('\u{7c0}', '\u{7c9}', GeneralCategory::DecimalNumber), ('\u{7ca}', '\u{7ea}',
        GeneralCategory::OtherLetter), ('\u{7eb}', '\u{7f3}', GeneralCategory::NonspacingMark),
        ('\u{7f4}', '\u{7f5}', GeneralCategory::ModifierLetter), ('\u{7f6}', '\u{7f6}',
        GeneralCategory::OtherSymbol), ('\u{7f7}', '\u{7f9}', GeneralCategory::OtherPunctuation),
        ('\u{7fa}', '\u{7fa}', GeneralCategory::ModifierLetter), ('\u{7fd}', '\u{7fd}',
        GeneralCategory::NonspacingMark), ('\u{7fe}', '\u{7ff}', GeneralCategory::CurrencySymbol),
        ('\u{800}', '\u{815}', GeneralCategory::OtherLetter), ('\u{816}', '\u{819}',
        GeneralCategory::NonspacingMark), ('\u{81a}', '\u{81a}', GeneralCategory::ModifierLetter),
        ('\u{81b}', '\u{823}', GeneralCategory::NonspacingMark), ('\u{824}', '\u{824}',
        GeneralCategory::ModifierLetter), ('\u{825}', '\u{827}', GeneralCategory::NonspacingMark),
        ('\u{828}', '\u{828}', GeneralCategory::ModifierLetter), ('\u{829}', '\u{82d}',
        GeneralCategory::NonspacingMark), ('\u{830}', '\u{83e}', GeneralCategory::OtherPunctuation),
        ('\u{840}', '\u{858}', GeneralCategory::OtherLetter), ('\u{859}', '\u{85b}',
        GeneralCategory::NonspacingMark), ('\u{85e}', '\u{85e}', GeneralCategory::OtherPunctuation),
        ('\u{860}', '\u{86a}', GeneralCategory::OtherLetter), ('\u{870}', '\u{887}',
        GeneralCategory::OtherLetter), ('\u{888}', '\u{888}', GeneralCategory::ModifierSymbol),
        ('\u{889}', '\u{88f}', GeneralCategory::OtherLetter), ('\u{890}', '\u{891}',
        GeneralCategory::Format), ('\u{897}', '\u{89f}', GeneralCategory::NonspacingMark),
        ('\u{8a0}', '\u{8c8}', GeneralCategory::OtherLetter), ('\u{8c9}', '\u{8c9}',
        GeneralCategory::ModifierLetter), ('\u{8ca}', '\u{8e1}', GeneralCategory::NonspacingMark),
        ('\u{8e2}', '\u{8e2}', GeneralCategory::Format), ('\u{8e3}', '\u{902}',
        GeneralCategory::NonspacingMark), ('\u{903}', '\u{903}', GeneralCategory::SpacingMark),
        ('\u{904}', '\u{939}', GeneralCategory::OtherLetter), ('\u{93a}', '\u{93a}',
        GeneralCategory::NonspacingMark), ('\u{93b}', '\u{93b}', GeneralCategory::SpacingMark),
        ('\u{93c}', '\u{93c}', GeneralCategory::NonspacingMark), ('\u{93d}', '\u{93d}',
        GeneralCategory::OtherLetter), ('\u{93e}', '\u{940}', GeneralCategory::SpacingMark),
        ('\u{941}', '\u{948}', GeneralCategory::NonspacingMark), ('\u{949}', '\u{94c}',
        GeneralCategory::SpacingMark), ('\u{94d}', '\u{94d}', GeneralCategory::NonspacingMark),
        ('\u{94e}', '\u{94f}', GeneralCategory::SpacingMark), ('\u{950}', '\u{950}',
        GeneralCategory::OtherLetter), ('\u{951}', '\u{957}', GeneralCategory::NonspacingMark),
        ('\u{958}', '\u{961}', GeneralCategory::OtherLetter), ('\u{962}', '\u{963}',
        GeneralCategory::NonspacingMark), ('\u{964}', '\u{965}', GeneralCategory::OtherPunctuation),
        ('\u{966}', '\u{96f}', GeneralCategory::DecimalNumber), ('\u{970}', '\u{970}',
        GeneralCategory::OtherPunctuation), ('\u{971}', '\u{971}', GeneralCategory::ModifierLetter),
        ('\u{972}', '\u{980}', GeneralCategory::OtherLetter), ('\u{981}', '\u{981}',
        GeneralCategory::NonspacingMark), ('\u{982}', '\u{983}', GeneralCategory::SpacingMark),
        ('\u{985}', '\u{98c}', GeneralCategory::OtherLetter), ('\u{98f}', '\u{990}',
        GeneralCategory::OtherLetter), ('\u{993}', '\u{9a8}', GeneralCategory::OtherLetter),
        ('\u{9aa}', '\u{9b0}', GeneralCategory::OtherLetter), ('\u{9b2}', '\u{9b2}',
        GeneralCategory::OtherLetter), ('\u{9b6}', '\u{9b9}', GeneralCategory::OtherLetter),
        ('\u{9bc}', '\u{9bc}', GeneralCategory::NonspacingMark), ('\u{9bd}', '\u{9bd}',
        GeneralCategory::OtherLetter), ('\u{9be}', '\u{9c0}', GeneralCategory::SpacingMark),
        ('\u{9c1}', '\u{9c4}', GeneralCategory::NonspacingMark), ('\u{9c7}', '\u{9c8}',
        GeneralCategory::SpacingMark), ('\u{9cb}', '\u{9cc}', GeneralCategory::SpacingMark),
        ('\u{9cd}', '\u{9cd}', GeneralCategory::NonspacingMark), ('\u{9ce}', '\u{9ce}',
        GeneralCategory::OtherLetter), ('\u{9d7}', '\u{9d7}', GeneralCategory::SpacingMark),
        ('\u{9dc}', '\u{9dd}', GeneralCategory::OtherLetter), ('\u{9df}', '\u{9e1}',
        GeneralCategory::OtherLetter), ('\u{9e2}', '\u{9e3}', GeneralCategory::NonspacingMark),
        ('\u{9e6}', '\u{9ef}', GeneralCategory::DecimalNumber), ('\u{9f0}', '\u{9f1}',
        GeneralCategory::OtherLetter), ('\u{9f2}', '\u{9f3}', GeneralCategory::CurrencySymbol),
        ('\u{9f4}', '\u{9f9}', GeneralCategory::OtherNumber), ('\u{9fa}', '\u{9fa}',
        GeneralCategory::OtherSymbol), ('\u{9fb}', '\u{9fb}', GeneralCategory::CurrencySymbol),
        ('\u{9fc}', '\u{9fc}', GeneralCategory::OtherLetter), ('\u{9fd}', '\u{9fd}',
        GeneralCategory::OtherPunctuation), ('\u{9fe}', '\u{9fe}', GeneralCategory::NonspacingMark),
        ('\u{a01}', '\u{a02}', GeneralCategory::NonspacingMark), ('\u{a03}', '\u{a03}',
        GeneralCategory::SpacingMark), ('\u{a05}', '\u{a0a}', GeneralCategory::OtherLetter),
        ('\u{a0f}', '\u{a10}', GeneralCategory::OtherLetter), ('\u{a13}', '\u{a28}',
        GeneralCategory::OtherLetter), ('\u{a2a}', '\u{a30}', GeneralCategory::OtherLetter),
        ('\u{a32}', '\u{a33}', GeneralCategory::OtherLetter), ('\u{a35}', '\u{a36}',
        GeneralCategory::OtherLetter), ('\u{a38}', '\u{a39}', GeneralCategory::OtherLetter),
        ('\u{a3c}', '\u{a3c}', GeneralCategory::NonspacingMark), ('\u{a3e}', '\u{a40}',
        GeneralCategory::SpacingMark), ('\u{a41}', '\u{a42}', GeneralCategory::NonspacingMark),
        ('\u{a47}', '\u{a48}', GeneralCategory::NonspacingMark), ('\u{a4b}', '\u{a4d}',
        GeneralCategory::NonspacingMark), ('\u{a51}', '\u{a51}', GeneralCategory::NonspacingMark),
        ('\u{a59}', '\u{a5c}', GeneralCategory::OtherLetter), ('\u{a5e}', '\u{a5e}',
        GeneralCategory::OtherLetter), ('\u{a66}', '\u{a6f}', GeneralCategory::DecimalNumber),
        ('\u{a70}', '\u{a71}', GeneralCategory::NonspacingMark), ('\u{a72}', '\u{a74}',
        GeneralCategory::OtherLetter), ('\u{a75}', '\u{a75}', GeneralCategory::NonspacingMark),
        ('\u{a76}', '\u{a76}', GeneralCategory::OtherPunctuation), ('\u{a81}', '\u{a82}',
        GeneralCategory::NonspacingMark), ('\u{a83}', '\u{a83}', GeneralCategory::SpacingMark),
        ('\u{a85}', '\u{a8d}', GeneralCategory::OtherLetter), ('\u{a8f}', '\u{a91}',
        GeneralCategory::OtherLetter), ('\u{a93}', '\u{aa8}', GeneralCategory::OtherLetter),
        ('\u{aaa}', '\u{ab0}', GeneralCategory::OtherLetter), ('\u{ab2}', '\u{ab3}',
        GeneralCategory::OtherLetter), ('\u{ab5}', '\u{ab9}', GeneralCategory::OtherLetter),
        ('\u{abc}', '\u{abc}', GeneralCategory::NonspacingMark), ('\u{abd}', '\u{abd}',
        GeneralCategory::OtherLetter), ('\u{abe}', '\u{ac0}', GeneralCategory::SpacingMark),
        ('\u{ac1}', '\u{ac5}', GeneralCategory::NonspacingMark), ('\u{ac7}', '\u{ac8}',
        GeneralCategory::NonspacingMark), ('\u{ac9}', '\u{ac9}', GeneralCategory::SpacingMark),
        ('\u{acb}', '\u{acc}', GeneralCategory::SpacingMark), ('\u{acd}', '\u{acd}',
        GeneralCategory::NonspacingMark), ('\u{ad0}', '\u{ad0}', GeneralCategory::OtherLetter),
        ('\u{ae0}', '\u{ae1}', GeneralCategory::OtherLetter), ('\u{ae2}', '\u{ae3}',
        GeneralCategory::NonspacingMark), ('\u{ae6}', '\u{aef}', GeneralCategory::DecimalNumber),
        ('\u{af0}', '\u{af0}', GeneralCategory::OtherPunctuation), ('\u{af1}', '\u{af1}',
        GeneralCategory::CurrencySymbol), ('\u{af9}', '\u{af9}', GeneralCategory::OtherLetter),
        ('\u{afa}', '\u{aff}', GeneralCategory::NonspacingMark), ('\u{b01}', '\u{b01}',
        GeneralCategory::NonspacingMark), ('\u{b02}', '\u{b03}', GeneralCategory::SpacingMark),
        ('\u{b05}', '\u{b0c}', GeneralCategory::OtherLetter), ('\u{b0f}', '\u{b10}',
        GeneralCategory::OtherLetter), ('\u{b13}', '\u{b28}', GeneralCategory::OtherLetter),
        ('\u{b2a}', '\u{b30}', GeneralCategory::OtherLetter), ('\u{b32}', '\u{b33}',
        GeneralCategory::OtherLetter), ('\u{b35}', '\u{b39}', GeneralCategory::OtherLetter),
        ('\u{b3c}', '\u{b3c}', GeneralCategory::NonspacingMark), ('\u{b3d}', '\u{b3d}',
        GeneralCategory::OtherLetter), ('\u{b3e}', '\u{b3e}', GeneralCategory::SpacingMark),
        ('\u{b3f}', '\u{b3f}', GeneralCategory::NonspacingMark), ('\u{b40}', '\u{b40}',
        GeneralCategory::SpacingMark), ('\u{b41}', '\u{b44}', GeneralCategory::NonspacingMark),
        ('\u{b47}', '\u{b48}', GeneralCategory::SpacingMark), ('\u{b4b}', '\u{b4c}',
        GeneralCategory::SpacingMark), ('\u{b4d}', '\u{b4d}', GeneralCategory::NonspacingMark),
        ('\u{b53}', '\u{b56}', GeneralCategory::NonspacingMark), ('\u{b57}', '\u{b57}',
        GeneralCategory::SpacingMark), ('\u{b5c}', '\u{b5d}', GeneralCategory::OtherLetter),
        ('\u{b5f}', '\u{b61}', GeneralCategory::OtherLetter), ('\u{b62}', '\u{b63}',
        GeneralCategory::NonspacingMark), ('\u{b66}', '\u{b6f}', GeneralCategory::DecimalNumber),
        ('\u{b70}', '\u{b70}', GeneralCategory::OtherSymbol), ('\u{b71}', '\u{b71}',
        GeneralCategory::OtherLetter), ('\u{b72}', '\u{b77}', GeneralCategory::OtherNumber),
        ('\u{b82}', '\u{b82}', GeneralCategory::NonspacingMark), ('\u{b83}', '\u{b83}',
        GeneralCategory::OtherLetter), ('\u{b85}', '\u{b8a}', GeneralCategory::OtherLetter),
        ('\u{b8e}', '\u{b90}', GeneralCategory::OtherLetter), ('\u{b92}', '\u{b95}',
        GeneralCategory::OtherLetter), ('\u{b99}', '\u{b9a}', GeneralCategory::OtherLetter),
        ('\u{b9c}', '\u{b9c}', GeneralCategory::OtherLetter), ('\u{b9e}', '\u{b9f}',
        GeneralCategory::OtherLetter), ('\u{ba3}', '\u{ba4}', GeneralCategory::OtherLetter),
        ('\u{ba8}', '\u{baa}', GeneralCategory::OtherLetter), ('\u{bae}', '\u{bb9}',
        GeneralCategory::OtherLetter), ('\u{bbe}', '\u{bbf}', GeneralCategory::SpacingMark),
        ('\u{bc0}', '\u{bc0}', GeneralCategory::NonspacingMark), ('\u{bc1}', '\u{bc2}',
        GeneralCategory::SpacingMark), ('\u{bc6}', '\u{bc8}', GeneralCategory::SpacingMark),
        ('\u{bca}', '\u{bcc}', GeneralCategory::SpacingMark), ('\u{bcd}', '\u{bcd}',
        GeneralCategory::NonspacingMark), ('\u{bd0}', '\u{bd0}', GeneralCategory::OtherLetter),
        ('\u{bd7}', '\u{bd7}', GeneralCategory::SpacingMark), ('\u{be6}', '\u{bef}',
        GeneralCategory::DecimalNumber), ('\u{bf0}', '\u{bf2}', GeneralCategory::OtherNumber),
        ('\u{bf3}', '\u{bf8}', GeneralCategory::OtherSymbol), ('\u{bf9}', '\u{bf9}',
        GeneralCategory::CurrencySymbol), ('\u{bfa}', '\u{bfa}', GeneralCategory::OtherSymbol),
        ('\u{c00}', '\u{c00}', GeneralCategory::NonspacingMark), ('\u{c01}', '\u{c03}',
        GeneralCategory::SpacingMark), ('\u{c04}', '\u{c04}', GeneralCategory::NonspacingMark),
        ('\u{c05}', '\u{c0c}', GeneralCategory::OtherLetter), ('\u{c0e}', '\u{c10}',
        GeneralCategory::OtherLetter), ('\u{c12}', '\u{c28}', GeneralCategory::OtherLetter),
        ('\u{c2a}', '\u{c39}', GeneralCategory::OtherLetter), ('\u{c3c}', '\u{c3c}',
        GeneralCategory::NonspacingMark), ('\u{c3d}', '\u{c3d}', GeneralCategory::OtherLetter),
        ('\u{c3e}', '\u{c40}', GeneralCategory::NonspacingMark), ('\u{c41}', '\u{c44}',
        GeneralCategory::SpacingMark), ('\u{c46}', '\u{c48}', GeneralCategory::NonspacingMark),
        ('\u{c4a}', '\u{c4d}', GeneralCategory::NonspacingMark), ('\u{c55}', '\u{c56}',
        GeneralCategory::NonspacingMark), ('\u{c58}', '\u{c5a}', GeneralCategory::OtherLetter),
        ('\u{c5c}', '\u{c5d}', GeneralCategory::OtherLetter), ('\u{c60}', '\u{c61}',
        GeneralCategory::OtherLetter), ('\u{c62}', '\u{c63}', GeneralCategory::NonspacingMark),
        ('\u{c66}', '\u{c6f}', GeneralCategory::DecimalNumber), ('\u{c77}', '\u{c77}',
        GeneralCategory::OtherPunctuation), ('\u{c78}', '\u{c7e}', GeneralCategory::OtherNumber),
        ('\u{c7f}', '\u{c7f}', GeneralCategory::OtherSymbol), ('\u{c80}', '\u{c80}',
        GeneralCategory::OtherLetter), ('\u{c81}', '\u{c81}', GeneralCategory::NonspacingMark),
        ('\u{c82}', '\u{c83}', GeneralCategory::SpacingMark), ('\u{c84}', '\u{c84}',
        GeneralCategory::OtherPunctuation), ('\u{c85}', '\u{c8c}', GeneralCategory::OtherLetter),
        ('\u{c8e}', '\u{c90}', GeneralCategory::OtherLetter), ('\u{c92}', '\u{ca8}',
        GeneralCategory::OtherLetter), ('\u{caa}', '\u{cb3}', GeneralCategory::OtherLetter),
        ('\u{cb5}', '\u{cb9}', GeneralCategory::OtherLetter), ('\u{cbc}', '\u{cbc}',
        GeneralCategory::NonspacingMark), ('\u{cbd}', '\u{cbd}', GeneralCategory::OtherLetter),
        ('\u{cbe}', '\u{cbe}', GeneralCategory::SpacingMark), ('\u{cbf}', '\u{cbf}',
        GeneralCategory::NonspacingMark), ('\u{cc0}', '\u{cc4}', GeneralCategory::SpacingMark),
        ('\u{cc6}', '\u{cc6}', GeneralCategory::NonspacingMark), ('\u{cc7}', '\u{cc8}',
        GeneralCategory::SpacingMark), ('\u{cca}', '\u{ccb}', GeneralCategory::SpacingMark),
        ('\u{ccc}', '\u{ccd}', GeneralCategory::NonspacingMark), ('\u{cd5}', '\u{cd6}',
        GeneralCategory::SpacingMark), ('\u{cdc}', '\u{cde}', GeneralCategory::OtherLetter),
        ('\u{ce0}', '\u{ce1}', GeneralCategory::OtherLetter), ('\u{ce2}', '\u{ce3}',
        GeneralCategory::NonspacingMark), ('\u{ce6}', '\u{cef}', GeneralCategory::DecimalNumber),
        ('\u{cf1}', '\u{cf2}', GeneralCategory::OtherLetter), ('\u{cf3}', '\u{cf3}',
        GeneralCategory::SpacingMark), ('\u{d00}', '\u{d01}', GeneralCategory::NonspacingMark),
        ('\u{d02}', '\u{d03}', GeneralCategory::SpacingMark), ('\u{d04}', '\u{d0c}',
        GeneralCategory::OtherLetter), ('\u{d0e}', '\u{d10}', GeneralCategory::OtherLetter),
        ('\u{d12}', '\u{d3a}', GeneralCategory::OtherLetter), ('\u{d3b}', '\u{d3c}',
        GeneralCategory::NonspacingMark), ('\u{d3d}', '\u{d3d}', GeneralCategory::OtherLetter),
        ('\u{d3e}', '\u{d40}', GeneralCategory::SpacingMark), ('\u{d41}', '\u{d44}',
        GeneralCategory::NonspacingMark), ('\u{d46}', '\u{d48}', GeneralCategory::SpacingMark),
        ('\u{d4a}', '\u{d4c}', GeneralCategory::SpacingMark), ('\u{d4d}', '\u{d4d}',
        GeneralCategory::NonspacingMark), ('\u{d4e}', '\u{d4e}', GeneralCategory::OtherLetter),
        ('\u{d4f}', '\u{d4f}', GeneralCategory::OtherSymbol), ('\u{d54}', '\u{d56}',
        GeneralCategory::OtherLetter), ('\u{d57}', '\u{d57}', GeneralCategory::SpacingMark),
        ('\u{d58}', '\u{d5e}', GeneralCategory::OtherNumber), ('\u{d5f}', '\u{d61}',
        GeneralCategory::OtherLetter), ('\u{d62}', '\u{d63}', GeneralCategory::NonspacingMark),
        ('\u{d66}', '\u{d6f}', GeneralCategory::DecimalNumber), ('\u{d70}', '\u{d78}',
        GeneralCategory::OtherNumber), ('\u{d79}', '\u{d79}', GeneralCategory::OtherSymbol),
        ('\u{d7a}', '\u{d7f}', GeneralCategory::OtherLetter), ('\u{d81}', '\u{d81}',
        GeneralCategory::NonspacingMark), ('\u{d82}', '\u{d83}', GeneralCategory::SpacingMark),
        ('\u{d85}', '\u{d96}', GeneralCategory::OtherLetter), ('\u{d9a}', '\u{db1}',
        GeneralCategory::OtherLetter), ('\u{db3}', '\u{dbb}', GeneralCategory::OtherLetter),
        ('\u{dbd}', '\u{dbd}', GeneralCategory::OtherLetter), ('\u{dc0}', '\u{dc6}',
        GeneralCategory::OtherLetter), ('\u{dca}', '\u{dca}', GeneralCategory::NonspacingMark),
        ('\u{dcf}', '\u{dd1}', GeneralCategory::SpacingMark), ('\u{dd2}', '\u{dd4}',
        GeneralCategory::NonspacingMark), ('\u{dd6}', '\u{dd6}', GeneralCategory::NonspacingMark),
        ('\u{dd8}', '\u{ddf}', GeneralCategory::SpacingMark), ('\u{de6}', '\u{def}',
        GeneralCategory::DecimalNumber), ('\u{df2}', '\u{df3}', GeneralCategory::SpacingMark),
        ('\u{df4}', '\u{df4}', GeneralCategory::OtherPunctuation), ('\u{e01}', '\u{e30}',
        GeneralCategory::OtherLetter), ('\u{e31}', '\u{e31}', GeneralCategory::NonspacingMark),
        ('\u{e32}', '\u{e33}', GeneralCategory::OtherLetter), ('\u{e34}', '\u{e3a}',
        GeneralCategory::NonspacingMark), ('\u{e3f}', '\u{e3f}', GeneralCategory::CurrencySymbol),
        ('\u{e40}', '\u{e45}', GeneralCategory::OtherLetter), ('\u{e46}', '\u{e46}',
        GeneralCategory::ModifierLetter), ('\u{e47}', '\u{e4e}', GeneralCategory::NonspacingMark),
        ('\u{e4f}', '\u{e4f}', GeneralCategory::OtherPunctuation), ('\u{e50}', '\u{e59}',
        GeneralCategory::DecimalNumber), ('\u{e5a}', '\u{e5b}', GeneralCategory::OtherPunctuation),
        ('\u{e81}', '\u{e82}', GeneralCategory::OtherLetter), ('\u{e84}', '\u{e84}',
        GeneralCategory::OtherLetter), ('\u{e86}', '\u{e8a}', GeneralCategory::OtherLetter),
        ('\u{e8c}', '\u{ea3}', GeneralCategory::OtherLetter), ('\u{ea5}', '\u{ea5}',
        GeneralCategory::OtherLetter), ('\u{ea7}', '\u{eb0}', GeneralCategory::OtherLetter),
        ('\u{eb1}', '\u{eb1}', GeneralCategory::NonspacingMark), ('\u{eb2}', '\u{eb3}',
        GeneralCategory::OtherLetter), ('\u{eb4}', '\u{ebc}', GeneralCategory::NonspacingMark),
        ('\u{ebd}', '\u{ebd}', GeneralCategory::OtherLetter), ('\u{ec0}', '\u{ec4}',
        GeneralCategory::OtherLetter), ('\u{ec6}', '\u{ec6}', GeneralCategory::ModifierLetter),
        ('\u{ec8}', '\u{ece}', GeneralCategory::NonspacingMark), ('\u{ed0}', '\u{ed9}',
        GeneralCategory::DecimalNumber), ('\u{edc}', '\u{edf}', GeneralCategory::OtherLetter),
        ('\u{f00}', '\u{f00}', GeneralCategory::OtherLetter), ('\u{f01}', '\u{f03}',
        GeneralCategory::OtherSymbol), ('\u{f04}', '\u{f12}', GeneralCategory::OtherPunctuation),
        ('\u{f13}', '\u{f13}', GeneralCategory::OtherSymbol), ('\u{f14}', '\u{f14}',
        GeneralCategory::OtherPunctuation), ('\u{f15}', '\u{f17}', GeneralCategory::OtherSymbol),
        ('\u{f18}', '\u{f19}', GeneralCategory::NonspacingMark), ('\u{f1a}', '\u{f1f}',
        GeneralCategory::OtherSymbol), ('\u{f20}', '\u{f29}', GeneralCategory::DecimalNumber),
        ('\u{f2a}', '\u{f33}', GeneralCategory::OtherNumber), ('\u{f34}', '\u{f34}',
        GeneralCategory::OtherSymbol), ('\u{f35}', '\u{f35}', GeneralCategory::NonspacingMark),
        ('\u{f36}', '\u{f36}', GeneralCategory::OtherSymbol), ('\u{f37}', '\u{f37}',
        GeneralCategory::NonspacingMark), ('\u{f38}', '\u{f38}', GeneralCategory::OtherSymbol),
        ('\u{f39}', '\u{f39}', GeneralCategory::NonspacingMark), ('\u{f3a}', '\u{f3a}',
        GeneralCategory::OpenPunctuation), ('\u{f3b}', '\u{f3b}',
        ...
        ('\u{1abf}', '\u{1af0}', GeneralCategory::NonspacingMark), ('\u{1b00}', '\u{1b03}',
        ...
        GeneralCategory::ClosePunctuation), ('\u{208f}', '\u{209f}',
        GeneralCategory::ModifierLetter), ('\u{20a0}', '\u{20c4}', GeneralCategory::CurrencySymbol),
        ...
        GeneralCategory::DashPunctuation), ('\u{2e60}', '\u{2e61}',
        GeneralCategory::OtherPunctuation), ('\u{2e62}', '\u{2e62}',
        GeneralCategory::OpenPunctuation), ('\u{2e63}', '\u{2e63}',
        GeneralCategory::ClosePunctuation), ('\u{2e80}', '\u{2e99}', GeneralCategory::OtherSymbol),
        ...
        GeneralCategory::LowercaseLetter), ('\u{a7dc}', '\u{a7dd}',
        GeneralCategory::UppercaseLetter), ('\u{a7e2}', '\u{a7e2}',
        ...
        ('\u{ab6c}', '\u{ab6d}', GeneralCategory::UppercaseLetter), ('\u{ab70}', '\u{abbf}',
        GeneralCategory::LowercaseLetter), ('\u{abc0}', '\u{abe2}', GeneralCategory::OtherLetter),
        ('\u{abe3}', '\u{abe4}', GeneralCategory::SpacingMark), ('\u{abe5}', '\u{abe5}',
        GeneralCategory::NonspacingMark), ('\u{abe6}', '\u{abe7}', GeneralCategory::SpacingMark),
        ('\u{abe8}', '\u{abe8}', GeneralCategory::NonspacingMark), ('\u{abe9}', '\u{abea}',
        GeneralCategory::SpacingMark), ('\u{abeb}', '\u{abeb}', GeneralCategory::OtherPunctuation),
        ('\u{abec}', '\u{abec}', GeneralCategory::SpacingMark), ('\u{abed}', '\u{abed}',
        GeneralCategory::NonspacingMark), ('\u{abf0}', '\u{abf9}', GeneralCategory::DecimalNumber),
        ('\u{ac00}', '\u{d7a3}', GeneralCategory::OtherLetter), ('\u{d7b0}', '\u{d7c6}',
        GeneralCategory::OtherLetter), ('\u{d7cb}', '\u{d7fb}', GeneralCategory::OtherLetter),
        ('\u{e000}', '\u{f8ff}', GeneralCategory::PrivateUse), ('\u{f900}', '\u{fa6d}',
        GeneralCategory::OtherLetter), ('\u{fa70}', '\u{fad9}', GeneralCategory::OtherLetter),
        ('\u{fb00}', '\u{fb06}', GeneralCategory::LowercaseLetter), ('\u{fb13}', '\u{fb17}',
        GeneralCategory::LowercaseLetter), ('\u{fb1d}', '\u{fb1d}', GeneralCategory::OtherLetter),
        ('\u{fb1e}', '\u{fb1e}', GeneralCategory::NonspacingMark), ('\u{fb1f}', '\u{fb28}',
        GeneralCategory::OtherLetter), ('\u{fb29}', '\u{fb29}', GeneralCategory::MathSymbol),
        ('\u{fb2a}', '\u{fb36}', GeneralCategory::OtherLetter), ('\u{fb38}', '\u{fb3c}',
        GeneralCategory::OtherLetter), ('\u{fb3e}', '\u{fb3e}', GeneralCategory::OtherLetter),
        ('\u{fb40}', '\u{fb41}', GeneralCategory::OtherLetter), ('\u{fb43}', '\u{fb44}',
        GeneralCategory::OtherLetter), ('\u{fb46}', '\u{fbb1}', GeneralCategory::OtherLetter),
        ('\u{fbb2}', '\u{fbc2}', GeneralCategory::ModifierSymbol), ('\u{fbc3}', '\u{fbd2}',
        GeneralCategory::OtherSymbol), ('\u{fbd3}', '\u{fd3d}', GeneralCategory::OtherLetter),
        ('\u{fd3e}', '\u{fd3e}', GeneralCategory::ClosePunctuation), ('\u{fd3f}', '\u{fd3f}',
        GeneralCategory::OpenPunctuation), ('\u{fd40}', '\u{fd4f}', GeneralCategory::OtherSymbol),
        ('\u{fd50}', '\u{fd8f}', GeneralCategory::OtherLetter), ('\u{fd90}', '\u{fd91}',
        GeneralCategory::OtherSymbol), ('\u{fd92}', '\u{fdc7}', GeneralCategory::OtherLetter),
        ('\u{fdc8}', '\u{fdcf}', GeneralCategory::OtherSymbol), ('\u{fdf0}', '\u{fdfb}',
        GeneralCategory::OtherLetter), ('\u{fdfc}', '\u{fdfc}', GeneralCategory::CurrencySymbol),
        ('\u{fdfd}', '\u{fdff}', GeneralCategory::OtherSymbol), ('\u{fe00}', '\u{fe0f}',
        GeneralCategory::NonspacingMark), ('\u{fe10}', '\u{fe16}',
        ...
        GeneralCategory::ModifierLetter), ('\u{107b2}', '\u{107bf}',
        ...
        GeneralCategory::OtherLetter), ('\u{10ec9}', '\u{10eca}', GeneralCategory::ModifierSymbol),
        ('\u{10ecb}', '\u{10ecf}', GeneralCategory::NonspacingMark), ('\u{10ed0}', '\u{10ed0}',
        GeneralCategory::OtherPunctuation), ('\u{10ed1}', '\u{10ed8}',
        GeneralCategory::OtherSymbol), ('\u{10ed9}', '\u{10eee}', GeneralCategory::OtherLetter),
        ('\u{10ef0}', '\u{10eff}', GeneralCategory::NonspacingMark), ('\u{10f00}', '\u{10f1c}',
        ...
        GeneralCategory::OtherPunctuation), ('\u{11b0a}', '\u{11b0a}',
        GeneralCategory::OtherLetter), ('\u{11b60}', '\u{11b60}', GeneralCategory::NonspacingMark),
        ('\u{11b61}', '\u{11b61}', GeneralCategory::SpacingMark), ('\u{11b62}', '\u{11b64}',
        GeneralCategory::NonspacingMark), ('\u{11b65}', '\u{11b65}', GeneralCategory::SpacingMark),
        ('\u{11b66}', '\u{11b66}', GeneralCategory::NonspacingMark), ('\u{11b67}', '\u{11b67}',
        GeneralCategory::SpacingMark), ('\u{11bc0}', '\u{11be0}', GeneralCategory::OtherLetter),
        ('\u{11be1}', '\u{11be1}', GeneralCategory::OtherPunctuation), ('\u{11bf0}', '\u{11bf9}',
        ...
        GeneralCategory::DecimalNumber), ('\u{11df0}', '\u{11df0}',
        GeneralCategory::NonspacingMark), ('\u{11df1}', '\u{11df1}', GeneralCategory::OtherLetter),
        ('\u{11ee0}', '\u{11ef2}', GeneralCategory::OtherLetter), ('\u{11ef3}', '\u{11ef4}',
        GeneralCategory::NonspacingMark), ('\u{11ef5}', '\u{11ef6}', GeneralCategory::SpacingMark),
        ('\u{11ef7}', '\u{11ef8}', GeneralCategory::OtherPunctuation), ('\u{11f00}', '\u{11f01}',
        ...
        GeneralCategory::OtherLetter), ('\u{12400}', '\u{1246f}', GeneralCategory::LetterNumber),
        ('\u{12470}', '\u{12474}', GeneralCategory::OtherPunctuation), ('\u{12475}', '\u{1247f}',
        GeneralCategory::LetterNumber), ('\u{12480}', '\u{12543}', GeneralCategory::OtherLetter),
        ('\u{12550}', '\u{12686}', GeneralCategory::LetterNumber), ('\u{12f90}', '\u{12ff0}',
        GeneralCategory::OtherLetter), ('\u{12ff1}', '\u{12ff2}',
        GeneralCategory::OtherPunctuation), ('\u{13000}', '\u{1342f}',
        ...
        GeneralCategory::LetterNumber), ('\u{17000}', '\u{18cda}', GeneralCategory::OtherLetter),
        ('\u{18cff}', '\u{18d20}', GeneralCategory::OtherLetter), ('\u{18d80}', '\u{18df2}',
        GeneralCategory::OtherLetter), ('\u{18e00}', '\u{19191}', GeneralCategory::OtherLetter),
        ('\u{191a0}', '\u{191d2}', GeneralCategory::OtherLetter), ('\u{1aff0}', '\u{1aff3}',
        GeneralCategory::ModifierLetter), ('\u{1aff5}', '\u{1affb}',
        GeneralCategory::ModifierLetter), ('\u{1affd}', '\u{1affe}',
        GeneralCategory::ModifierLetter), ('\u{1b000}', '\u{1b128}', GeneralCategory::OtherLetter),
        ...
        ('\u{1b164}', '\u{1b168}', GeneralCategory::OtherLetter), ('\u{1b170}', '\u{1b2fb}',
        ...
        GeneralCategory::OtherSymbol), ('\u{1ced2}', '\u{1ced4}', GeneralCategory::OtherSymbol),
        ('\u{1cedd}', '\u{1cedf}', GeneralCategory::MathSymbol), ('\u{1cee0}', '\u{1ceef}',
        GeneralCategory::OtherSymbol), ('\u{1cef0}', '\u{1cefd}', GeneralCategory::MathSymbol),
        ...
        GeneralCategory::OtherSymbol), ('\u{1d127}', '\u{1d128}', GeneralCategory::NonspacingMark),
        ('\u{1d129}', '\u{1d164}', GeneralCategory::OtherSymbol), ('\u{1d165}', '\u{1d166}',
        GeneralCategory::SpacingMark), ('\u{1d167}', '\u{1d169}', GeneralCategory::NonspacingMark),
        ('\u{1d16a}', '\u{1d16c}', GeneralCategory::OtherSymbol), ('\u{1d16d}', '\u{1d172}',
        GeneralCategory::SpacingMark), ('\u{1d173}', '\u{1d17a}', GeneralCategory::Format),
        ('\u{1d17b}', '\u{1d182}', GeneralCategory::NonspacingMark), ('\u{1d183}', '\u{1d184}',
        GeneralCategory::OtherSymbol), ('\u{1d185}', '\u{1d18b}', GeneralCategory::NonspacingMark),
        ('\u{1d18c}', '\u{1d1a9}', GeneralCategory::OtherSymbol), ('\u{1d1aa}', '\u{1d1ad}',
        GeneralCategory::NonspacingMark), ('\u{1d1ae}', '\u{1d241}', GeneralCategory::OtherSymbol),
        ('\u{1d242}', '\u{1d244}', GeneralCategory::NonspacingMark), ('\u{1d245}', '\u{1d245}',
        GeneralCategory::OtherSymbol), ('\u{1d250}', '\u{1d252}', GeneralCategory::SpacingMark),
        ('\u{1d253}', '\u{1d25a}', GeneralCategory::OtherSymbol), ('\u{1d25b}', '\u{1d25c}',
        GeneralCategory::NonspacingMark), ('\u{1d25d}', '\u{1d25e}', GeneralCategory::OtherSymbol),
        ('\u{1d25f}', '\u{1d25f}', GeneralCategory::SpacingMark), ('\u{1d260}', '\u{1d27f}',
        GeneralCategory::OtherSymbol), ('\u{1d280}', '\u{1d281}', GeneralCategory::SpacingMark),
        ('\u{1d2c0}', '\u{1d2d3}', GeneralCategory::OtherNumber), ('\u{1d2e0}', '\u{1d2f3}',
        GeneralCategory::OtherNumber), ('\u{1d300}', '\u{1d356}', GeneralCategory::OtherSymbol),
        ('\u{1d360}', '\u{1d378}', GeneralCategory::OtherNumber), ('\u{1d400}', '\u{1d419}',
        GeneralCategory::UppercaseLetter), ('\u{1d41a}', '\u{1d433}',
        ...
        GeneralCategory::UppercaseLetter), ('\u{1d68a}', '\u{1d6a6}',
        ...
        GeneralCategory::NonspacingMark), ('\u{1db00}', '\u{1db1c}', GeneralCategory::MathSymbol),
        ('\u{1df00}', '\u{1df09}', GeneralCategory::LowercaseLetter), ('\u{1df0a}', '\u{1df0a}',
        GeneralCategory::OtherLetter), ('\u{1df0b}', '\u{1df3f}', GeneralCategory::LowercaseLetter),
        ('\u{1df40}', '\u{1df40}', GeneralCategory::UppercaseLetter), ('\u{1df41}', '\u{1df47}',
        GeneralCategory::LowercaseLetter), ('\u{1df48}', '\u{1df48}',
        GeneralCategory::UppercaseLetter), ('\u{1df49}', '\u{1df49}',
        GeneralCategory::LowercaseLetter), ('\u{1df4a}', '\u{1df4a}',
        GeneralCategory::UppercaseLetter), ('\u{1df4b}', '\u{1df4c}',
        GeneralCategory::LowercaseLetter), ('\u{1df4d}', '\u{1df4d}',
        GeneralCategory::UppercaseLetter), ('\u{1df4e}', '\u{1df50}',
        GeneralCategory::LowercaseLetter), ('\u{1df51}', '\u{1df51}',
        GeneralCategory::UppercaseLetter), ('\u{1df52}', '\u{1df67}',
        GeneralCategory::LowercaseLetter), ('\u{1df68}', '\u{1df68}',
        GeneralCategory::UppercaseLetter), ('\u{1df69}', '\u{1df69}',
        GeneralCategory::LowercaseLetter), ('\u{1df6a}', '\u{1df6a}',
        GeneralCategory::UppercaseLetter), ('\u{1df6b}', '\u{1df6b}',
        GeneralCategory::LowercaseLetter), ('\u{1df6c}', '\u{1df6c}',
        GeneralCategory::UppercaseLetter), ('\u{1df6d}', '\u{1df6d}',
        GeneralCategory::LowercaseLetter), ('\u{1df6e}', '\u{1df6e}',
        GeneralCategory::UppercaseLetter), ('\u{1df6f}', '\u{1df71}',
        GeneralCategory::LowercaseLetter), ('\u{1df72}', '\u{1df72}',
        GeneralCategory::UppercaseLetter), ('\u{1df73}', '\u{1df73}',
        GeneralCategory::LowercaseLetter), ('\u{1df74}', '\u{1df74}',
        GeneralCategory::UppercaseLetter), ('\u{1df75}', '\u{1df75}',
        GeneralCategory::LowercaseLetter), ('\u{1df76}', '\u{1df76}',
        GeneralCategory::UppercaseLetter), ('\u{1df77}', '\u{1df77}',
        GeneralCategory::LowercaseLetter), ('\u{1df78}', '\u{1df78}',
        GeneralCategory::UppercaseLetter), ('\u{1df79}', '\u{1df79}',
        GeneralCategory::LowercaseLetter), ('\u{1df7a}', '\u{1df7a}',
        GeneralCategory::UppercaseLetter), ('\u{1df7b}', '\u{1df7b}',
        GeneralCategory::LowercaseLetter), ('\u{1df7c}', '\u{1df7c}',
        GeneralCategory::UppercaseLetter), ('\u{1df7d}', '\u{1df7d}',
        GeneralCategory::LowercaseLetter), ('\u{1df7e}', '\u{1df7e}',
        GeneralCategory::UppercaseLetter), ('\u{1df7f}', '\u{1df7f}',
        GeneralCategory::LowercaseLetter), ('\u{1df80}', '\u{1df81}', GeneralCategory::OtherLetter),
        ('\u{1df90}', '\u{1df96}', GeneralCategory::LowercaseLetter), ('\u{1dfcd}', '\u{1dfff}',
        GeneralCategory::ModifierLetter), ('\u{1e000}', '\u{1e006}',
        ...
        GeneralCategory::OtherNumber), ('\u{1f10d}', '\u{1f1ae}', GeneralCategory::OtherSymbol),
        ...
        ('\u{1f3fb}', '\u{1f3ff}', GeneralCategory::ModifierSymbol), ('\u{1f400}', '\u{1f6d9}',
        GeneralCategory::OtherSymbol), ('\u{1f6dc}', '\u{1f6ec}', GeneralCategory::OtherSymbol),
        ('\u{1f6f0}', '\u{1f6fc}', GeneralCategory::OtherSymbol), ('\u{1f700}', '\u{1f7db}',
        GeneralCategory::OtherSymbol), ('\u{1f7e0}', '\u{1f7eb}', GeneralCategory::OtherSymbol),
        ('\u{1f7f0}', '\u{1f80b}', GeneralCategory::OtherSymbol), ('\u{1f810}', '\u{1f847}',
        GeneralCategory::OtherSymbol), ('\u{1f850}', '\u{1f859}', GeneralCategory::OtherSymbol),
        ('\u{1f860}', '\u{1f887}', GeneralCategory::OtherSymbol), ('\u{1f890}', '\u{1f8ad}',
        GeneralCategory::OtherSymbol), ('\u{1f8b0}', '\u{1f8bb}', GeneralCategory::OtherSymbol),
        ('\u{1f8c0}', '\u{1f8c1}', GeneralCategory::OtherSymbol), ('\u{1f8d0}', '\u{1f8d8}',
        GeneralCategory::MathSymbol), ('\u{1f900}', '\u{1fa57}', GeneralCategory::OtherSymbol),
        ('\u{1fa60}', '\u{1fa6d}', GeneralCategory::OtherSymbol), ('\u{1fa70}', '\u{1fa7c}',
        GeneralCategory::OtherSymbol), ('\u{1fa80}', '\u{1fac6}', GeneralCategory::OtherSymbol),
        ('\u{1fac8}', '\u{1fac8}', GeneralCategory::OtherSymbol), ('\u{1facc}', '\u{1fadd}',
        GeneralCategory::OtherSymbol), ('\u{1fadf}', '\u{1faeb}', GeneralCategory::OtherSymbol),
        ('\u{1faef}', '\u{1fafa}', GeneralCategory::OtherSymbol), ('\u{1fb00}', '\u{1fb92}',
        GeneralCategory::OtherSymbol), ('\u{1fb94}', '\u{1fbef}', GeneralCategory::OtherSymbol),
        ('\u{1fbf0}', '\u{1fbf9}', GeneralCategory::DecimalNumber), ('\u{1fbfa}', '\u{1fbfa}',
        GeneralCategory::OtherSymbol), ('\u{20000}', '\u{2a6df}', GeneralCategory::OtherLetter),
        ('\u{2a700}', '\u{2b81e}', GeneralCategory::OtherLetter), ('\u{2b820}', '\u{2cead}',
        GeneralCategory::OtherLetter), ('\u{2ceb0}', '\u{2ebe0}', GeneralCategory::OtherLetter),
        ('\u{2ebf0}', '\u{2ee5d}', GeneralCategory::OtherLetter), ('\u{2f800}', '\u{2fa1d}',
        GeneralCategory::OtherLetter), ('\u{30000}', '\u{3134a}', GeneralCategory::OtherLetter),
        ('\u{31350}', '\u{33479}', GeneralCategory::OtherLetter), ('\u{3d000}', '\u{3fc3f}',
...
pub mod emoji {
    ...
    const EMOJI_STATUS: &[(char, char, EmojiStatus)] = &[
        ...
        EmojiStatus::EmojiPresentation), ('\u{1f6d9}', '\u{1f6d9}', EmojiStatus::EmojiPresentation),
        ('\u{1f6da}', '\u{1f6db}', EmojiStatus::NonEmoji), ('\u{1f6dc}', '\u{1f6dc}',
        EmojiStatus::EmojiPresentation), ('\u{1f6dd}', '\u{1f6df}', EmojiStatus::EmojiPresentation),
        ('\u{1f6e0}', '\u{1f6e5}', EmojiStatus::EmojiOther), ('\u{1f6e6}', '\u{1f6e8}',
        EmojiStatus::NonEmoji), ('\u{1f6e9}', '\u{1f6e9}', EmojiStatus::EmojiOther), ('\u{1f6ea}',
        '\u{1f6ea}', EmojiStatus::NonEmoji), ('\u{1f6eb}', '\u{1f6ec}',
        EmojiStatus::EmojiPresentation), ('\u{1f6ed}', '\u{1f6ef}', EmojiStatus::NonEmoji),
        ('\u{1f6f0}', '\u{1f6f0}', EmojiStatus::EmojiOther), ('\u{1f6f1}', '\u{1f6f2}',
        EmojiStatus::NonEmoji), ('\u{1f6f3}', '\u{1f6f3}', EmojiStatus::EmojiOther), ('\u{1f6f4}',
        '\u{1f6f6}', EmojiStatus::EmojiPresentation), ('\u{1f6f7}', '\u{1f6f8}',
        ...
        ('\u{1fa8b}', '\u{1fa8d}', EmojiStatus::EmojiPresentation), ('\u{1fa8e}', '\u{1fa8e}',
        ...
        ('\u{1fac8}', '\u{1fac8}', EmojiStatus::EmojiPresentation), ('\u{1fac9}', '\u{1facb}',
        EmojiStatus::NonEmoji), ('\u{1facc}', '\u{1facc}', EmojiStatus::EmojiPresentation),
        ('\u{1facd}', '\u{1facd}', EmojiStatus::EmojiPresentation), ('\u{1face}', '\u{1facf}',
        ...
        EmojiStatus::EmojiPresentation), ('\u{1fadc}', '\u{1fadc}', EmojiStatus::EmojiPresentation),
        ('\u{1fadd}', '\u{1fadd}', EmojiStatus::EmojiPresentation), ('\u{1fade}', '\u{1fade}',
        EmojiStatus::NonEmoji), ('\u{1fadf}', '\u{1fadf}', EmojiStatus::EmojiPresentation),
        ('\u{1fae0}', '\u{1fae7}', EmojiStatus::EmojiPresentation), ('\u{1fae8}', '\u{1fae8}',
        EmojiStatus::EmojiPresentation), ('\u{1fae9}', '\u{1fae9}', EmojiStatus::EmojiPresentation),
        ('\u{1faea}', '\u{1faea}', EmojiStatus::EmojiPresentation), ('\u{1faeb}', '\u{1faeb}',
        EmojiStatus::EmojiPresentation), ('\u{1faec}', '\u{1faee}', EmojiStatus::NonEmoji),
        ...
        EmojiStatus::EmojiPresentationAndModifierBase), ('\u{1faf9}', '\u{1fafa}',
        EmojiStatus::EmojiPresentationAndModifierBase), ('\u{1fafb}', '\u{e001f}',
